        ...
        <Container className="mt-24 pb-24 sm:py-32 lg:pb-56 flex">
          <FadeIn  className="flex flex-col md:flex-row gap-6 items-center justify-start max-w-7xl">
            <div className="">
              ...
              <h1 className="font-display md:hidden text-5xl font-bold tracking-tight text-gradient-accent [text-wrap:balance] sm:text-7xl">
               <span className="text-primary-accent">{t("title")}</span>   <br />
                <span className="">{t("subtitle")}</span>
              </h1>
